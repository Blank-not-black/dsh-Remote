...
const files = ['index.html', 'styles.css', 'theme-vars.css', 'app.js', 'i18n.js', 'theme.js', 'sha256.js', 'jsqr.min.js', 'md.js', 'admin.html', 'admin.js', 'plugin.html', 'plugin.js', 'qrcode.min.js', 'manifest.webmanifest', 'icon.svg', 'donate.png', 'version.json', 'update.json', 'announcements.json']
const dirs = ['desktop']
