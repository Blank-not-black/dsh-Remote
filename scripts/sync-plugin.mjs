...
const files = ['index.html', 'styles.css', 'theme-vars.css', 'app.js', 'i18n.js', 'theme.js', 'sha256.js', 'jsqr.min.js', 'admin.html', 'admin.js', 'qrcode.min.js', 'manifest.webmanifest', 'icon.svg', 'version.json', 'update.json']
const dirs = ['desktop']
